CREATE OR REPLACE FUNCTION public.airspace_zones_intersecting_route(p_route jsonb, p_buffer_m integer, p_zone_types text[] DEFAULT NULL::text[], p_country_codes text[] DEFAULT NULL::text[], p_layer_ids text[] DEFAULT NULL::text[])
