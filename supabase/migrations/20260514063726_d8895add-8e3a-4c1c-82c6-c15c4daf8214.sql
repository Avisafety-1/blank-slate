...
UPDATE public.mission_map_publications
SET ends_at = starts_at + interval '24 hours',
    visible_until = GREATEST(COALESCE(visible_until, starts_at + interval '24 hours'), starts_at + interval '24 hours'),
    updated_at = now()
