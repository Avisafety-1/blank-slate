...
BEGIN
  ...
  IF NOT public.has_role(v_uid, 'superadmin')
     ...
     AND NOT public.can_user_access_company(v_uid, v_log.company_id) THEN
  ...
  IF v_drone_changed THEN
    ...
    END IF;
    IF NOT public.has_role(v_uid, 'superadmin')
       AND NOT public.can_user_access_company(v_uid, v_new_drone_company) THEN
  ...
  IF v_pilot_changed THEN
    ...
    IF NOT public.has_role(v_uid, 'superadmin')
       ...
       AND NOT public.can_user_access_company(v_uid, v_new_pilot_company) THEN
