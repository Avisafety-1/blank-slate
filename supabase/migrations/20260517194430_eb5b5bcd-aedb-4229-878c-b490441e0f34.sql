...
REVOKE EXECUTE ON FUNCTION public.admin_trigger_edge_function(text, jsonb) FROM PUBLIC, anon;
GRANT EXECUTE ON FUNCTION public.admin_trigger_edge_function(text, jsonb) TO authenticated;