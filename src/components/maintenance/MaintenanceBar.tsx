...
export const MaintenanceBar = ({
  ...
  return (
    <div className="grid grid-cols-[4.5rem_1fr_minmax(0,9rem)] items-center gap-2 sm:gap-3">
      ...
      <span
        className={cn(
          "block text-xs font-semibold tabular-nums tracking-tight text-right whitespace-nowrap overflow-hidden text-ellipsis",
