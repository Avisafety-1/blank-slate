  ...
  public: {
    Tables: {
      ...
      user_dronelog_keys: {
        ...
        Relationships: [
          {
            foreignKeyName: "user_dronelog_keys_user_id_fkey"
            columns: ["user_id"]
            isOneToOne: true
            referencedRelation: "profiles"
            referencedColumns: ["id"]
    ...
    Functions: {
      ...
      get_propagating_parent_company_id:
        ...
        | { Args: { _company_id: string; _flag: string }; Returns: string }
      ...
      set_deviation_status: {
        Args: { _deviation_id: string; _status: string }
        Returns: undefined
      }
      set_resource_status: {
