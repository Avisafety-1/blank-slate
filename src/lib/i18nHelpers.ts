...
const ROOT_CAUSE: DbValueMap = {
  ...
  "Menneskelig feil/svikt": { en: "Human error/failure" },
  "Materiellsvikt": { en: "Equipment failure" },
  "Metode eller systemfeil": { en: "Method or system failure" },
  "Management/ledelse": { en: "Management" },
  "Ytre miljøpåvirkning": { en: "External environmental influence" },
  ...
  "Uhell": { en: "Accident" },
  "Brukerfeil": { en: "User error" },
  "Brudd på prosedyre": { en: "Procedure breach" },
  "Mangelfull prosedyre": { en: "Inadequate procedure" },
  "Mangelfull opplæring": { en: "Inadequate training" },
  "Annen menneskelig feil/svikt": { en: "Other human error/failure" },
  "Stress/høy belastning": { en: "Stress/high workload" },
  "Forandring i rutiner": { en: "Change in routines" },
  "Sykdom": { en: "Illness" },
  "Mangelfull årvåkenhet": { en: "Inadequate vigilance" },
  "Uegnet teknisk løsning": { en: "Unsuitable technical solution" },
  "Fugler/dyr": { en: "Birds/animals" },
  "ATC-klarering": { en: "ATC clearance" },
  "Nærpassering": { en: "Near miss" },
  "Annet": { en: "Other" },
  "Ukjent": { en: "Unknown" },
};
