...
| 1.4 | `src/pages/Kart.tsx` + kart-popups | WIP | Kart.tsx migrert 2026-07-12: alle toasts, tooltip-titler, planlegg-flyrute-panel (mobil+desktop), SORA/adjacent toggle, back-to-mission, 2D/3D toggle, inspect mode. Nye nøkler: `pages.map.{loading,points_one,points_other,kmlImported,importFailed,importingKml,kmlLabel,importKmlTitle,fh2Title,tooLargeForSafeSky,large,outsideCount,pilot,clickShort,removePilotShort,undoTitle,clearTitle,cancelTitle,saveTitle,routeUpdateFailed,routeSavedWithSora,missionNotFound,missionHasNoSavedRoute,pilotPositionSet,closeSoraVolume,backToMission,switchTo2D,switchTo3D,switchTo3DExperimental,inspectModeActive,inspectModeTitle,planNewRoute}`. Ressurskalender-timeline (`ResourceTimeline.tsx`) migrert samme dag: `pages.calendar.resourceTimeline.*` med språkbasert date-fns locale (nb/enUS). Kalender.tsx date-locale også språkbevisst. Neste steg: kart-popups i `OpenAIPMap.tsx`, `Map3D.tsx`, `SoraSettingsPanel`, `AdjacentAreaPanel`, `FlightHub2SendDialog`. |
